import { currentKstMonthPeriod, getCurrentKstYear } from "./time.js";

export const CURRENT_YEAR = getCurrentKstYear();
export const CURRENT_MONTH_PERIOD = currentKstMonthPeriod();
export const CURRENT_MONTH_UNCONFIRMED_PERIOD = "현재 월 공지 확인 필요";
...
export const CARD_SOURCES = [
  {
    ...
    urls: [
      {
        label: "공식 무이자할부 안내",
        url: "https://www.shinhancard.com/pconts/html/benefit/info/CONFM50046/CONFM50046R01.html?crustMenuId=ms152",
        priority: "primary"
      }
    ],
    fallback: {
      period: CURRENT_MONTH_UNCONFIRMED_PERIOD,
  ...
  },
  {
    ...
    urls: [
      {
        label: "공식 진행중 이벤트",
        url: "https://card.nonghyup.com/servlet/IpCo0001M.act",
        priority: "primary",
        searchKeywords: ["무이자할부", "무이자 할부", "업종별 무이자할부"]
      },
      {
        label: "공식 2026년 업종별 무이자할부 혜택",
        url: "https://card.nonghyup.com/servlet/IpCb2002R.act?EVT_CRT_SQNO=5896",
    ...
    fallback: {
      ...
      minimumAmount: "5만원 이상",
      notes: [
        "공식 2026년 업종별 무이자할부 혜택 게시글 기준입니다. 홈페이지 접속이 차단되면 보조값으로 표시합니다."
      ]
    }
  },
  {
