const FALLBACK_INDUSTRIES = [
  { id: "all", label: "전체/일반" },
  { id: "tax", label: "국세/지방세" },
  { id: "hospital", label: "병원/의료" },
  { id: "education", label: "학원/교육" },
  { id: "auto", label: "자동차/보험" },
  { id: "shopping", label: "쇼핑/생활편의" }
];

const SOURCE_NOTE = "공식 업종별 세부 조건을 자동 확인하지 못했습니다. 원문 확인이 필요합니다.";
  ...
  shinhan: [
    {
      ...
      partialMonths: ["7개월", "9개월", "10개월", "11개월", "12개월", "18개월", "23개월", "24개월"],
    ...
    },
    {
      ...
      minimumAmount: "5만원 이상",
      notes: ["국세는 10/12/18/24개월 슬림할부, 지방세는 10/12개월 슬림할부가 표시됩니다."]
    },
    {
      id: "hospital",
      label: "병원/의료",
      ...
      minimumAmount: "5만원 이상",
      notes: ["종합병원은 10/12개월, 일반병원은 10개월 슬림할부가 표시됩니다."]
    },
    {
      id: "education",
      label: "학원/교육",
      ...
      partialMonths: ["10개월", "12개월"],
      minimumAmount: "5만원 이상",
      notes: ["학원은 2~3개월, 대학등록금은 2~3개월 및 10/12개월 슬림할부가 표시됩니다."]
    },
    {
      id: "auto",
      label: "자동차/보험",
      ...
      minimumAmount: "5만원 이상",
      notes: ["손해보험은 2~5개월 및 7/9/11개월 슬림할부, 차량정비는 2~3개월 및 10개월 슬림할부가 표시됩니다."]
    },
    {
      id: "shopping",
      label: "쇼핑/생활편의",
      ...
      partialMonths: [],
      minimumAmount: "5만원 이상",
      notes: ["온라인 쇼핑, 백화점, 대형마트 등은 업종/가맹점별 조건이 다르게 표시됩니다."]
    }
  ],
  samsung: [
    {
      ...
      label: "전체/일반",
      noInterestMonths: ["2~5개월", "2~3개월"],
      partialMonths: ["6개월", "7개월", "10개월", "11개월", "12개월", "18개월", "23개월", "24개월"],
      minimumAmount: "5만원 이상",
    ...
    },
    {
      ...
      notes: ["삼성카드 공식 업종표에는 국세/지방세 조건이 확인되지 않았습니다."]
    },
    {
      id: "hospital",
      label: "병원/의료",
      ...
      minimumAmount: "5만원 이상",
      notes: ["병원은 2~5개월 무이자, 병원이 포함된 묶음 업종에는 7/11개월 다이어트 할부가 표시됩니다."]
    },
    {
      id: "education",
      label: "학원/교육",
      ...
      minimumAmount: "5만원 이상",
      notes: ["학원은 2~3개월, 대학등록금은 2~3개월 및 6/10/12개월 다이어트 할부가 표시됩니다."]
    },
    {
      id: "auto",
      label: "자동차/보험",
      ...
      minimumAmount: "5만원 이상",
      notes: ["자동차보험은 2~5개월 무이자 및 7/11/18/24개월 다이어트 할부가 표시됩니다."]
    },
    {
      id: "shopping",
      label: "쇼핑/생활편의",
      ...
      minimumAmount: "5만원 이상",
      notes: ["아울렛, 백화점, 대형마트, 온라인쇼핑몰 등은 업종별로 2~5개월 또는 2~3개월 무이자가 표시됩니다. 백화점 10개월은 100만원 이상 조건입니다."]
    }
  ]
};
  ...
  return FALLBACK_INDUSTRIES.map((industry) => {
    if (industry.id === "all") {
      return {
        ...
        notes: ["카드사 대표 조건입니다. 업종별 세부 조건은 원문 확인이 필요합니다."]
      };
    }
